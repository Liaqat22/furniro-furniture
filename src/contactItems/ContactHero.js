  ...
  return (
    ...
    <div className='flex justify-center items-center relative'>
                ...
                <div className='absolute  flex flex-col gap-2'>
                    ...
                    <h1 className='capitalize text-4xl text-center '>contact</h1>
                    <Breadcrumbs aria-label="breadcrumb">
                        <NavLink className="no-underline capitalize text-lg text-textblack font-semibold" to="/"> home </NavLink>
                        <NavLink className="no-underline capitalize text-textblack font-medium " to="/contact"> contact </NavLink>
                    </Breadcrumbs>
                </div>
            </div>
