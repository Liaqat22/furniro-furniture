  ...
  return (
    ...
    <div className='flex justify-center items-center relative'>
                ...
                <div className='absolute  flex flex-col gap-2'>
                    ...
                    <h1 className='capitalize text-4xl text-center '>checkout</h1>
                    <Breadcrumbs aria-label="breadcrumb">
                        <NavLink className="no-underline capitalize text-lg text-textblack font-semibold" to="/"> home </NavLink>
                        <NavLink className="no-underline capitalize text-textblack font-medium " to="/checkout"> checkout </NavLink>
                    </Breadcrumbs>
                </div>
            </div>
            <CheckOutForm/>
