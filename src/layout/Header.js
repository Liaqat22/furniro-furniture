...
{tabs.map((t,i)=>(
    <li key={i} className='list-none'>
      <NavLink to={t.url} className="no-underline capitalize text-[#000000] font-semibold" >{t?.title}</NavLink>
      </li>
))}
</ul>
  </Grid2>
...
{icons.map((t,i)=>(
    <li key={i} className='list-none'>
      <NavLink to ={t.url} className="no-underline capitalize text-[#000000] font-semibold">
